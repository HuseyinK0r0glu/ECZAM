...
class _DoseRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () => _guardStock(context, () => app.toggleTaken(med, minute)),
  ...
  /// Runs a dose-logging action, surfacing INSUFFICIENT_STOCK (and other
  /// backend errors) as a snackbar instead of an unhandled exception.
  Future<void> _guardStock(
    ...
    try {
      ...
      messenger.showSnackBar(
        SnackBar(
          content: Text(e.code == 'INSUFFICIENT_STOCK'
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                ...
                _guardStock(
                    context, () => app.setDoseStatus(med, minute, DoseStatus.taken));
              },
            ),
            ListTile(
              leading: const Icon(
