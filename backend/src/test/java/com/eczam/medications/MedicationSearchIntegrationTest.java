...
class MedicationSearchIntegrationTest extends AbstractIntegrationTest {
    ...
    void blank_query_still_lists_everything_alphabetically() {
        ...
        // Compared case-insensitively: Postgres's default locale collation
        // sorts case-insensitively-first (e.g. "Zeta" before "ZZQVEXMED…"),
        // unlike Java's raw ordinal String::compareTo.
